 ...
 */
class clientsMax20 extends database {
/*
 ...
 */
     ...
     */
    public function clientsMax20List() {
        $listQuery = 'SELECT `id`, `lastName`, `firstName`, `birthDate`, `card`, `cardNumber` FROM `clients` LIMIT 20';
