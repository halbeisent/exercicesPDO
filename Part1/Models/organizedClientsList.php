 ...
 */
class organizedClients extends database {
/*
 ...
 */
     ...
     */
    public function organizedClientsList() {
        $listQuery = 'SELECT `id`, `lastName`, `firstName`, DATE_FORMAT(`birthDate`, "%d/%m/%Y") AS `birthDate`, `card`, `cardNumber`, CASE WHEN `card` = 0 THEN "Non" ELSE "Oui" END  AS `condition` FROM `clients`';
