 ...
 */
class clientsNameBeginsWithM extends database {
/*
 ...
 */
     ...
     */
    public function clientsNameBeginsWithMList() {
        $listQuery = 'SELECT `id`, `lastName`, `firstName`, `birthDate`, `card`, `cardNumber` FROM `clients` WHERE `lastName` like "M%" ORDER BY `firstName`';
